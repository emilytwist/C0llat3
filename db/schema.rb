...
ActiveRecord::Schema.define(version: 2019_01_16_095234) do
  ...
  create_table "products_studies", id: false, force: :cascade do |t|
    t.bigint "study_id"
    t.bigint "product_id"
    t.index ["product_id"], name: "index_products_studies_on_product_id"
    t.index ["study_id"], name: "index_products_studies_on_study_id"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "last_viewed", default: [], array: true
